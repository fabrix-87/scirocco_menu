  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="sticky top-0 z-50 w-full border-b border-card-border bg-background/95 backdrop-blur-md">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="grid h-12 grid-cols-3 items-center md:flex md:justify-end">
            ...
            <div className="flex items-center justify-center md:hidden">
              <div
                className={`relative h-6 w-24 transition-all duration-300 ${
                  isScrolled
        ...
        <div
          className={`absolute left-0 w-full border-b border-card-border bg-card/98 shadow-xl transition-all duration-300 md:hidden ${
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <header className="mb-12 text-center px-4">
          {/* Contenitore fluido: largo il 100% su mobile, ma non supera mai i 450px. L'altezza si calcola da sola grazie all'aspect ratio */}
          <div className="relative mx-auto w-full max-w-112.5 aspect-450/240">
            <Image
              src="/images/scirocco-logo.png"
              alt="Scirocco 2025"
              fill
